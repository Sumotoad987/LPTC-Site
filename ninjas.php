		...
		<div class="top-nav">
			<span class="menu"><img src="images/menu.png" alt=""> </span>
				<ul>
					...
					<li><a href="blog.html" class="hvr-sweep-to-bottom">News</a></li>
	...
	<div class="container">
		<div id="bestProject">
			<div class="imageHolder">
				<div style="position:relative; height:600px;  margin: auto; width: 60%">
   					<div style="position:absolute;z-index:1">
      					<img src="images/bestProject.png">
   					</div>
   				<div style="position:absolute;top:360px; width:600px; height:400px; z-index:2;font-size:200%">
      				<center><b>Richard Beattie's website</b></center>
    			</div> 
			</div>
			</div>
			<a>Tom Armstrong</a>
